...
const faqs = [
  ...
  [
    ...
    {
      question: 'What happens if the chatbot doesn’t have the answer to my question?',
      answer:
...
const general_faqs = [
  {
    ...
    answer: 'You can find all the details about your benefits on the HR portal under the "Employee Benefits" section. If you need further assistance, feel free to contact the HR team directly.'
  },
  {
    question: 'How do I update my personal information with HR?',
    answer: 'To update your personal information, simply log in to the HR portal and go to the "Profile" section. If you need help, the HR team is always available via email.'
  },
  {
    question: 'Where can I access my pay stubs?',
    answer: "Pay stubs are available on the HR portal under Payroll. You can download and view them anytime. If you're having trouble accessing them, contact the payroll department."
  },
  {
    question: 'How do I request time off?',
    answer: 'You can request time off through the university’s employee management system. Go to the "Time Off" section and submit your request. HR will review and confirm.'
  },
  {
    question: 'I need to apply for family leave. What’s the process?',
    answer: 'For family leave, please visit the "Leave of Absence" section on the HR portal to download the application form. If you need assistance, you can also reach out to the HR team.'
  },
  {
    question: 'I’ve lost my university ID, what should I do?',
    answer: 'Please contact the HR team directly via email or visit the HR office. They will help you with a replacement ID and guide you through the process.'
  },
  {
    question: 'If the chatbot can’t answer my question, where should I go?',
    answer: 'If the chatbot can’t provide the answer, please reach out to the HR team via email or visit the HR office. They are always happy to assist you with more complex inquiries.'
  },
  {
    question: 'How can I access the university’s wellness programs?',
    answer: 'You can find information about wellness programs in the "Employee Wellness" section on the HR portal. Additionally, feel free to contact HR for specific details on available resources.'
  },
  {
    question: 'What are the university’s policies on remote work?',
    answer: 'The remote work policy is outlined in the HR handbook, which can be accessed through the HR portal. If you need clarification, HR is available to answer any questions you may have.'
  },
  {
    question: 'How do I submit a request for professional development funding?',
    answer: 'Professional development funding requests are submitted through the "Professional Development" section on the HR portal. Complete the form and HR will review your submission.'
  },
]
